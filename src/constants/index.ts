...
export const AboutSubtitles=[
    {   
        title:"About Me",
        text:"I am a tech-driven person who loves building, experimenting, and figuring out how things work. \nPretty chill by nature, but I get deeply focused when solving problems or coding. \nI am into software, new technologies, and hands-on projects that challenge me. \nIn my free time, you will usually find me coding, learning something new, or tinkering with ideas."
    },
    {   title:"School",
        text:"Schooling in Jawahar Navodaya Vidhyalaya Khandwa (Madhya Pradesh) \nwhere I developed a strong foundation in science and mathematics \nand Secured 93.2% in 10th and 93% in 12th board exams."
    },
    {
        title:"College",
        text:"Completed my B.Tech in Data Science Engineering from the prestigious Indian Institute of Technology, Mandi.\nHere, I honed my skills in data analysis, machine learning,and software development while engaging in various projects and research.Graduated with a CGPA of 8.03 out of 10."
    },
    {
        title:"Semester Exchange",
        text:"Had the incredible opportunity to be a semester exchange student at Kyushu University in Japan. This experience broadened my horizons, exposing me to new cultures and academic perspectives. It was a transformative period that enriched both my personal and professional growth. Secured a GPA of 9.65/10 during my exchange semester. "
    }
]
